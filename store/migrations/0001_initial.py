    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memember', models.CharField(choices=[('B', 'Bronze'), ('S', 'Silver'), ('G', 'Gold'), ('P', 'Platinum')], default='B', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Promotion',
        ...
        migrations.AddField(
            model_name='order',
            name='OrderItem',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='store.orderitem'),
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
